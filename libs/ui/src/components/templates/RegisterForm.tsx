'use client'
import { Role } from '@parkspace/util/types'
import { useFormRegister } from '@parkspace/forms/src/register'
import { useMutation } from '@apollo/client'
import { RegisterWithCredentialsDocument } from '@parkspace/network/src/gql/generated'
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 text-sm ">
        Already have an parkspace account?
        <br />
